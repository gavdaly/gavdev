        ...
        <div className="container">
          ...
          <Card id="brand" style={{ marginTop: '18px' }}>
            ...
            <div className="swatches" role="list">
              <Swatch color="var(--accent)" name="Aurora Lime" code="#33FF5F / color(display-p3 0.10 0.98 0.25)" />
              <Swatch color="var(--accent-2)" name="Solar Orange" code="#FF8C00 / color(display-p3 1 0.55 0)" />
              <Swatch color="var(--accent-3)" name="Ion Blue" code="#00B8FF / color(display-p3 0 0.72 1)" />
            </div>

                        <div className="lockups">
                          <Lockup type="horizontal" brandName="Your&nbsp;Brand" description="horizontal lockup" />
                          <Lockup type="stacked" brandName="Your&nbsp;Brand" description="stacked mark" />
                        </div>          </Card>
