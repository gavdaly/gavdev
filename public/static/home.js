    ...
    function copyAgeKey() {
      ...
      if (navigator.clipboard && navigator.clipboard.writeText) {
        ...
        navigator.clipboard.writeText(ageKey).then(() => {
          alert('Age public key copied to clipboard!');
        }).catch(err => {
          console.error('Failed to copy age public key using Clipboard API: ', err);
    ...
    function fallbackCopyTextToClipboard(text) {
      ...
      try {
        ...
        const msg = successful ? 'Age public key copied to clipboard!' : 'Failed to copy age public key.';
        alert(msg);
      } catch (err) {
